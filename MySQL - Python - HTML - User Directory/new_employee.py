...
<a class="active" href="new_hire.py">New Hires</a>
</div>
<div class=content>""")
...
cur.execute("insert into new_hire values(%s,%s,%s)", (name, job_title, date))
con.commit()

cur.close()
con.close()

print("<a href='new_hire.py' Click here to go back")
print("<h3>New Hire Created. Click to go back</h3>")
